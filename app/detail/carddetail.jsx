  ...
  return (
    <div className="group relative block overflow-hidden bg-white">
      ...
      <div className="relative border border-gray-100  p-6">
        ...
        <div class="text-2xl py-1 text-white mt-4 bg-red-500 w-fit rounded-lg px-2 font-semibold">Price: ${product.price}&nbsp;</div>
        <p className="mt-2 text-sm text-gray-700">Left in stock: {product.quantity}</p>
